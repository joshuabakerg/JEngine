...
public class main {
    ...
    public static void main(String[] args) {
        ...
        if (run) {
            ...
            Prefabs.init();
            if (multi) {
                network = new Networker(JOptionPane.showInputDialog("Enter name", "joshua"), JOptionPane.showInputDialog("enter ip address", "localhost"),
                        Integer.parseInt(JOptionPane.showInputDialog("port", "90")));
